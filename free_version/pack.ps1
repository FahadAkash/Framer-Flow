...
Write-Host "Packaging FrameFlow Free $Version..." -ForegroundColor Cyan
...
$stage = Join-Path ([System.IO.Path]::GetTempPath()) "FrameFlow-Free-pack-$Version"
if (Test-Path $stage) { Remove-Item $stage -Recurse -Force }
$payload = Join-Path $stage "FrameFlow Free"
...
$zip = Join-Path $dist "FrameFlow-Free-$Version.zip"
